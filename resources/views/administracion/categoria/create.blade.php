...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        ...
        {!! Form::open(['route' => 'categoria.store', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="container-fluid">
                    <div class="col-6 mt-4"></div>
                        <div class="col-6" style="text-align:right;">
                            ...
                            {!! link_to_route('categoria.index', $title = 'Cancelar', $parameters = [], $attributes = ['class' => 'btn btn-secondary separateBto']); !!}
                        </div>
                    </div><!-- /.container-fluid -->
            </section>
         {!! Form::close() !!}
