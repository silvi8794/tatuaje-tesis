...
{{--             <div class="col-2">
                <a href="{{ route('categoria.create') }}" class="btn float-right colorCyan" role="button">+ Add Categoria</a>
            </div> --}}
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                                <button type="button" class="btn paddBto" id="btoRestore_{{$categoria->id}}" onclick="activarCategoria({{$categoria->id}})" >
