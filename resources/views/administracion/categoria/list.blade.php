            ...
            <div class="card">
                <div class="row mb-4">
                    ...
                    <div class="col-lg-9">
                            ...
                            <a href="{{ route('categoria.create') }}" class="btn btn-info float-right" role="button" style=" border-bottom: 10px solid #ffffff margin-left: 5px; margin-top: 15px; margin-bottom: 5px; margin-right: 5px ">Crear Categoria</a>
                    </div>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button type="button" class="btn paddBto" data-user="{{$categoria}}" data-toggle="modal" data-target="#showCategoria{{ $categoria->id }}">
                                                <i class="fas fa-search"></i>
                                            </button>
                                            <form action="{{$categoria->id}}/edit" method="GET">
                                                <button type="submit" class="btn">
                                                        <i class="far fa-edit"></i>
                                                </button>
                                            </form>
                                                {!! Form::open(['route' => 'categoria.delete','id'=>'formDelete', 'name'=>'formDelete']) !!}
                                                    @method('DELETE')
                                                    {{-- {{ Form::hidden('id', $categoria->id) }} --}}
                                                    <input type="hidden" name="id" id="idCategoria">
                                                        <button type="button" class="btn" onclick="borrarCategoria({{ $categoria->id }})">
                                ...
                                @include('administracion/categoria/partials/actions')
