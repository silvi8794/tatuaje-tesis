                        ...
                        <div class="row">
                                ...
                                <div class="col-4 mb-4">
                                    @if((!empty($user->especialidad)))
                                        <input type="text" class="form-control colorInput" value="{{ $user->especialidad }}" disabled>
                                    @else
                                        <input type="text" class="form-control colorInput" value="" disabled>
                                    @endif
                        ...
                        <div class="row">
                                ...
                                <div class="col-4 mb-4">
                                    @if((!empty($user->sucursal)))
                                        <input type="text" class="form-control colorInput" value="{{ $user->sucursal->nombre }}" disabled>
                                    @else
                                        <input type="text" class="form-control colorInput" value="" disabled>
                                    @endif
...
{{--  <div class="modal fade" id="deleteUser{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header headerModel">
            <h5 class="modal-title colorLabel" id="staticBackdropLabel">Eliminar Usuario</h5>
        ...
        <div class="modal-body">
                ...
                <label class="colorLabel">Seguro de ELiminar el usuario</label><br>
