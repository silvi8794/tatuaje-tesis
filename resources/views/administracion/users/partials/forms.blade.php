            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="col-8">
                            {{ Form::textarea('especialidad', old('especialidad',$user->especialidad ?? ''), array_merge(['class' => 'form-control ', 'placeholder' => 'Especialidad', 'required' => true,'rows'=>'3','maxlength'=>'70'])) }}
                    ...
                    <div class="form-group">
                        ...
                        @endif
                            ...
                            @foreach( $sucursales as $sucursal)
                                ...
                                @if(!empty($user))
                                    <option value="{{$sucursal->id}}" {{ ($user->sucursal_id === $sucursal->id ? 'selected' : '') ? 'selected':''}} > {{$sucursal->nombre}}</option>
                                @else
                                    <option {{ old('selectSucursal') == $sucursal->id ? 'selected' : ''}} value="{{$sucursal->id}}"> {{$sucursal->nombre}}</option>
                                @endif
                            @endforeach
                        </select>
                        @if($errors->has('selectSucursal'))
                            <p class="text-danger">{{ $errors->first('selectSucursal') }}</p>
                        @endif
