    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-9">
                        <a href="{{ route('admin.create') }}" class="btn btn-info float-right" role="button" style=" border-bottom: 10px solid #ffffff margin-left: 5px; margin-top: 15px; margin-bottom: 5px; margin-right: 5px ">Crear Administrador</a>
                </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <form action="{{$user->id}}/edit" method="GET">
                                                ...
                                                {!! Form::open(['route' => 'admin.delete','id'=>'formDelete', 'name'=>'formDelete']) !!}
                                                    @method('DELETE')
