...
<!-- Modal Views-->
<div class="modal fade" id="showLugar{{ $lugar->id}}"  tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div class="row" style="margin-top: 0px !important;">
                            ...
                            <div class="col-4">
                                @if(!empty($lugar->nombre))
                                    <input type="text" class="form-control colorInput" value="{{ $lugar->nombre }}" disabled>
                                @else
