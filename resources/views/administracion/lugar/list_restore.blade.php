...
{{--             <div class="col-2">
                <a href="{{ route('lugar.create') }}" class="btn float-right colorCyan" role="button">+ Add Lugar</a>
            </div> --}}
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                                <button type="button" class="btn paddBto" id="btoRestore_{{$lugar->id}}" onclick="activarLugar({{$lugar->id}})" >
