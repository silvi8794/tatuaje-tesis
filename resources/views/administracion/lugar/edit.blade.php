          ...
          <div class="col-md-12">
                ...
                <div class="card card-warning">
                  ...
                  <div class="card-body">
                    ...
                    {!! Form::model($lugar,['route' => ['lugar.update', $lugar->id], 'method' => 'PUT','class' => 'form-horizontal', 'id' => 'userForm', 'enctype' => 'multipart/form-data']) !!}

                        @include('administracion.lugar.partials.forms')
                    ...
                    <section class="main-header navbar navbar-expand" style="position: fixed; left: 0; right: 0; bottom: 0px; z-index: 1; background-color: white; height:60px;">
                            <div class="container-fluid">
                                  ...
                                  <div class="col-6" style="text-align:right;">
                                      ...
                                      {!! link_to_route('lugar.index', $title = 'Cancelar', $parameters = [], $attributes = ['class' => 'btn btn-secondary']); !!}
