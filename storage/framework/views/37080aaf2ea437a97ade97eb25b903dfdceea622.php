...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        ...
        <div class="row col-12 mt-1 mb-3">
            <h3 class="titleModule">Crear Lugar</h3>
        </div>
        <?php echo Form::open(['route' => 'lugar.store', 'enctype' => 'multipart/form-data']); ?>
                ...
                <div class="container-fluid">
                    <div class="col-6 mt-4"></div>
                        <div class="col-6" style="text-align:right;">
                            ...
                            <?php echo link_to_route('lugar.index', $title = 'Cancelar', $parameters = [], $attributes = ['class' => 'btn btn-secondary separateBto']);; ?>
...
<?php echo $__env->make('administracion.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatuajes_tesis\resources\views/administracion/lugar/create.blade.php ENDPATH**/ ?>