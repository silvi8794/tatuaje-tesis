    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-lg-9">
                        <a href="<?php echo e(route('users.create')); ?>" class="btn btn-info float-right" role="button" style=" border-bottom: 10px solid #ffffff margin-left: 5px; margin-top: 15px; margin-bottom: 5px; margin-right: 5px ">Crear Tatuador</a>
                </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <form action="<?php echo e($user->id); ?>/edit" method="GET">
                                                ...
                                                <?php echo Form::open(['route' => 'users.delete','id'=>'formDelete', 'name'=>'formDelete']); ?>
...
<?php echo $__env->make('administracion.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatuajes_tesis\resources\views/administracion/users/list.blade.php ENDPATH**/ ?>