                    ...
                    <div class="row mb-5">
                      ...
                      <div class="col-8">
                          <select name="tatuador" id="tatuador" class="form-control" onchange="selectTatuador()">
                              ...
                              <?php $__currentLoopData = $tatuadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tatuador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option style="background-color:black" value="<?php echo e($tatuador->id); ?>"><?php echo e($tatuador->apellido); ?>, <?php echo e($tatuador->nombre); ?> ( Sucursal - <?php echo e($tatuador->sucursal->localidad->nombre); ?>)</option>
                                    ...
                                    <?php $__currentLoopData = $tatuajes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tatuaje): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                            <div class="col-md-3 mb-3">
                                                <div class="card">
                                                    <img src="<?php echo e(url($tatuaje->imagen)); ?>" width="100%" height="250" alt="Card image cap" onclick="seleccionImagen(<?php echo e($tatuaje); ?>)">
                                                </div>
                                            </div>
                                        <?php if($cont>3): ?>
                                                </div>
...
<?php echo $__env->make('cliente.layouts.app_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatuajes_tesis\resources\views/cliente/turno/create.blade.php ENDPATH**/ ?>