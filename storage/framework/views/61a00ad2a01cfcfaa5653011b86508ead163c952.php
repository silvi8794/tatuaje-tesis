...
<div class="content-wrapper">
    ...
    <div class="col-md-12">
        <div class="row col-12 mt-3 mb-5">
            <h3 class="titleModule">Crear Categoria</h3>
        </div>
        <?php echo Form::open(['route' => 'categoria.store', 'enctype' => 'multipart/form-data']); ?>
                ...
                <div class="container-fluid">
                    <div class="col-6 mt-4"></div>
                        <div class="col-6" style="text-align:right;">
                            ...
                            <?php echo link_to_route('categoria.index', $title = 'Cancelar', $parameters = [], $attributes = ['class' => 'btn btn-secondary separateBto']);; ?>
...
<?php echo $__env->make('administracion.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tatuajes_tesis\resources\views/administracion/categoria/create.blade.php ENDPATH**/ ?>