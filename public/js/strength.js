        ...
        init: function() {
            ...
            function get_total(total, thisid) {
                ...
                if (total == 0) {
                    ...
                    thismeter.addClass("veryweak").html("Level: very weak");
                } else if (total == 2) {
                    thismeter.removeClass();
                    thismeter.addClass("weak").html("Level: weak");
                } else if (total == 3) {
                    thismeter.removeClass();
                    thismeter.addClass("medium").html("Level: medium");
                } else {
                    thismeter.removeClass();
                    thismeter.addClass("strong").html("Level: strong");
                }
                console.log(total);
            }
            ...
            var strengthButtonTextToggle = this.options
            ...
            this.$elem.bind("keyup keydown", function(event) {
                thisval = $("#" + thisid).val();
                $('input[type="text"][data-password="' + thisid + '"]').val(
                    thisval
                );
